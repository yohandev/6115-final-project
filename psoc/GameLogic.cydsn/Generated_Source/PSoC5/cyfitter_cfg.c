...
#define BS_UDB_1_2_0_CONFIG_VAL ((const uint8 CYFAR *)0x480006A8u)
...
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x48000734u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG4_CFG0), 0xC34Fu);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT1_AG, 0x03u);
